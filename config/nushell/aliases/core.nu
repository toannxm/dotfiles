...
# Dotfiles management
export def dotfiles [...args: string] {
    let dotfiles_dir = ($"($env.HOME)/Workday/MacSetup/dotfiles" | path expand)
    git --git-dir=($dotfiles_dir)/.git/ --work-tree=($dotfiles_dir) ...$args
}
